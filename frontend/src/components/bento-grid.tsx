        ...
        <section className="relative px-4 py-24">
            ...
            <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-3">
                {pillars.map((pillar, i) => (
                    <ScrollReveal key={pillar.title} delay={i * 0.15} scale>
                        <div
                            className={`glass group relative flex h-full flex-col overflow-hidden p-8 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_12px_40px_rgba(0,0,0,0.06)] ${pillar.hoverBorder}`}
                        >
                            ...
                            <p className="text-annotation mb-3 text-sm">{pillar.annotation}</p>
